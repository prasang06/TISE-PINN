...
def psi_theta(params, x): #our prediction for psi
    x = jnp.array([x])
...
psi_batch = jax.vmap(psi_theta, in_axes=(None, 0))
...
def total_loss(params):
    return lambda_pde*pde_loss(params) + lambda_bc*boundarycond_loss(params) + lambda_norm*normal_loss(params)
